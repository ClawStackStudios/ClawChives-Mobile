# 🔌 ClawChives Server Boundary API Contract (v0.0.3.0)
...
- **Versioning Protocol**: The mobile application injects stateless `X-Client-Version: 0.0.3.0` and `Accept-Version: 0.0.3.0` headers on every outward request to explicitly communicate the client's protocol capability level.
